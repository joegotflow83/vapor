...
use aws_sdk_docdb::types::{DbCluster, DbInstance, Filter};
...
impl DocumentDbClient {
    pub fn new(config: &SdkConfig) -> Self {
        Self {
            inner: aws_sdk_docdb::Client::new(config),
        }
    }
    ...
    pub async fn describe_db_clusters(
        ...
        loop {
            ...
            if let Some(l) = limit {
                ...
                // cost_explorer.rs::get_cost_and_usage / neptune.rs.
...
mod tests {
    ...
    async fn describe_db_clusters_happy_path_no_limit() {
        let http_client = StaticReplayClient::new(vec![ReplayEvent::new(
            ...
            xml_response(
                ...
                "<DescribeDBClustersResponse><DescribeDBClustersResult><DBClusters>\
                 ...
                 <Engine>docdb</Engine><EngineVersion>4.0.0</EngineVersion><Port>27017</Port>\
        ...
        assert_eq!(clusters[0].engine(), Some("docdb"));
        assert_eq!(clusters[0].port(), Some(27017));
        ...
        let http_client = StaticReplayClient::new(vec![ReplayEvent::new(
            ...
            xml_response(
                ...
                "<DescribeDBInstancesResponse><DescribeDBInstancesResult><DBInstances>\
                 ...
                 <DBInstanceClass>db.r5.large</DBInstanceClass><Engine>docdb</Engine>\
