...
pub struct QueryRoot(
    ...
    #[cfg(feature = "ssoadmin")] crate::schema::sso_admin::queries::SsoAdminQuery,
    #[cfg(feature = "acmpca")] crate::schema::acm_pca::queries::AcmPcaQuery,
    #[cfg(feature = "ram")] crate::schema::ram::queries::RamQuery,
    #[cfg(feature = "controltower")] crate::schema::control_tower::queries::ControlTowerQuery,
    #[cfg(feature = "fms")] crate::schema::fms::queries::FmsQuery,
    #[cfg(feature = "auditmanager")] crate::schema::audit_manager::queries::AuditManagerQuery,
    #[cfg(feature = "detective")] crate::schema::detective::queries::DetectiveQuery,
    #[cfg(feature = "sesv2")] crate::schema::ses::queries::SesQuery,
    #[cfg(feature = "elasticbeanstalk")]
    crate::schema::elastic_beanstalk::queries::ElasticBeanstalkQuery,
    #[cfg(feature = "apprunner")] crate::schema::app_runner::queries::AppRunnerQuery,
    #[cfg(feature = "fsx")] crate::schema::fsx::queries::FsxQuery,
    #[cfg(feature = "mq")] crate::schema::mq::queries::MqQuery,
    #[cfg(feature = "dms")] crate::schema::dms::queries::DmsQuery,
    #[cfg(feature = "workspaces")] crate::schema::workspaces::queries::WorkspacesQuery,
    #[cfg(feature = "storagegateway")] crate::schema::storage_gateway::queries::StorageGatewayQuery,
    #[cfg(feature = "datasync")] crate::schema::datasync::queries::DataSyncQuery,
    #[cfg(feature = "lightsail")] crate::schema::lightsail::queries::LightsailQuery,
    #[cfg(feature = "qldb")] crate::schema::qldb::queries::QldbQuery,
    #[cfg(feature = "keyspaces")] crate::schema::keyspaces::queries::KeyspacesQuery,
    ...
    #[cfg(feature = "transcribe")] crate::schema::transcribe::queries::TranscribeQuery,
    #[cfg(feature = "translate")] crate::schema::translate::queries::TranslateQuery,
    #[cfg(feature = "polly")] crate::schema::polly::queries::PollyQuery,
    #[cfg(feature = "codeartifact")] crate::schema::codeartifact::queries::CodeArtifactQuery,
    #[cfg(feature = "codecommit")] crate::schema::codecommit::queries::CodeCommitQuery,
    #[cfg(feature = "iot")] crate::schema::iot::queries::IotQuery,
    #[cfg(feature = "licensemanager")] crate::schema::license_manager::queries::LicenseManagerQuery,
    #[cfg(feature = "budgets")] crate::schema::budgets::queries::BudgetsQuery,
    #[cfg(feature = "connect")] crate::schema::connect::queries::ConnectQuery,
    #[cfg(feature = "pinpoint")] crate::schema::pinpoint::queries::PinpointQuery,
);
